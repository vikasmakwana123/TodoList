    ...
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
        <div
          ...
          <img src={SearchLogo} alt="search" style={{ width: '30px', height: "30px", backgroundColor: 'whitesmoke' }} />
          <input
            type='text'
        ...
        <div style={{ display: 'flex', flexDirection: 'row', gap: '20px', position: 'relative', left: '15vw', marginTop: '10px' }}>
          <div
            ...
            {!button ? (
              <img src={DownIcon} alt="down" style={{ width: '20px', height: '20px', filter: 'invert(1)' }} />
            ) : (
              <img src={UpIcon} alt="up" style={{ width: '20px', height: '20px', filter: 'invert(1)' }} />
            )}
          </div>
